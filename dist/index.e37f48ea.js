...
const controlDeleteRecipe = async function(id) {
    ...
    try {
        ...
        if (_modelJs.state.recipe.id === id) // await model.deleteRecipe(model.state.recipe.id);
...
const AJAX = async function(url, uploadData, method = "GET") {
    try {
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    <figure class="recipe__fig">
        ...
        <div class="recipe__details">
          ...
          <button class="btn--round button--delete ${this._data.key ? "" : "hidden"}" data-recipe-id="${this._data.id}"> <svg>
...
},{"./View":"5cUXS","../../img/icons.svg":"cMpiy","fracty":"hJO4d","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
